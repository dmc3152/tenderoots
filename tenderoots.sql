...
INSERT INTO `feed` VALUES (1,-1,4,'2018-03-09 05:25:13','You have a new friend request!',0),(3,-2,1,'2018-03-09 08:35:30','This is a test feed message.',0),(4,1,4,'2018-03-09 10:08:33','Hey Friend! We should get together some time!',0);
...
INSERT INTO `friends` VALUES (1,3,'2018-03-08 02:29:52',1),(1,4,'2018-03-09 05:25:13',0),(2,1,'2018-03-08 02:29:52',1);
...
INSERT INTO `person_details` VALUES (1,'USR',1,'Test','User','test',NULL,'test','2018-03-03 20:37:36'),(2,'USR',2,'Friend','User',NULL,NULL,NULL,'2018-03-08 02:27:28'),(3,'USR',3,'Other','Friend',NULL,NULL,'I am the other friend. The friend that is around when you don\'t need me. I am fun to have but not really that cool. I need to keep saying stuff so that I can test out overflow stuff.','2018-03-08 02:28:06'),(4,'USR',4,'Friend','Request',NULL,NULL,'This is the bio for the friend request friend. The purpose of this is to test the positioning/size of the buttons to see if they will fit with a bio.','2018-03-08 03:03:35');
...
INSERT INTO `replies` VALUES (1,4,4,'2018-03-09 10:36:30','Yeah, that would be fun!',0);
...
INSERT INTO `users` VALUES (1,'test@email.com','$2y$10$r/q4D.nwryf4VsEVwr2KU.ldvsuPeDWY1AzaEHYFemIMFfz/2JT3a'),(2,'user@email.com','$2y$10$Pz9FSKWhrybZ846JQFb.VO/2CMjRWBvv/YoMgRa.rdHALJCSUBEnm'),(3,'other@email.com','$2y$10$AvvWHbxMwWr.SAEJvYFshOjuvGmWPdFm9TM.x9rkeIujEYqvLZpbK'),(4,'request@email.com','$2y$10$GpgzukOdoP3a3YeM67TLp.hwSik15287XAhRUen8bQIkKDwj9Oecy');
...
-- Dump completed on 2018-03-09 21:21:02
